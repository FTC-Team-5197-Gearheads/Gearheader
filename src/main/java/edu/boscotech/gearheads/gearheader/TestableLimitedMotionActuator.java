package edu.boscotech.gearheads.gearheader;
...
public class TestableLimitedMotionActuator extends LimitedDcMotorDrivenActuator {
    ...
    public int minLimit;
    public double speed;
    public DcMotorSimple.Direction direction = motor.getDirection();
    public TestableLimitedMotionActuator(final String MOTOR_NAME){
